...
@Service
@Transactional
public class PrioritePtfService {

    private final Logger log = LoggerFactory.getLogger(PrioritePtfService.class);

    private final PrioritePtfRepository prioritePtfRepository;

    public PrioritePtfService(PrioritePtfRepository prioritePtfRepository) {
