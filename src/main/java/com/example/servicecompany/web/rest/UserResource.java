...
import com.example.servicecompany.web.errors.BadRequestAlertException;
import com.example.servicecompany.web.errors.LoginAlreadyUsedException;
import com.example.servicecompany.web.vm.UpdateEmail;
...
//    @Value("${jhipster.clientApp.name}")
     ...
     */
    @PostMapping("/users")
   // @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.CompanyOwner + "\")")
  ...
  //  @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.CompanyOwner + "\")")
    ...
    @GetMapping("/users/desactivate/{userId}")
    public void desactivateUser(@PathVariable UUID userId) {
...
//    @GetMapping("/users/companyOfOwner/{ownerId}")
//    public Company getCompanyOfOwner(@PathVariable Long ownerId) {
//        log.debug("REST request to get users of Company");
//        return  userService.getCompanyOfOwner(ownerId);
//
//    }

    /**
     * {@code GET  /userss/:id} : get the "id" user.
     *
...
//
//        return userRepository.findOneWithAuthoritiesByLoginIgnoreCase(email);
//    }
    ...
    public ResponseEntity<Boolean> checkEmail(@RequestParam("email") String email) {
     ...
     Boolean result = userService.checkMail(email);
