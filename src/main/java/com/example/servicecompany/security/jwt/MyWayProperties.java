...
public class MyWayProperties {
    ...
    private final MyWayProperties.Gateway gateway = new MyWayProperties.Gateway();
    private final MyWayProperties.Mail mail = new MyWayProperties.Mail();
    ...
    public MyWayProperties.Gateway getGateway() {
        return this.gateway;
    }
    public MyWayProperties.Mail getMail() {
        return this.mail;
    }

    public static class Gateway {
        private final MyWayProperties.Gateway.RateLimiting rateLimiting = new MyWayProperties.Gateway.RateLimiting();
        ...
        public MyWayProperties.Gateway.RateLimiting getRateLimiting() {
