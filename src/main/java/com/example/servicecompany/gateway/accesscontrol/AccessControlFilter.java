package com.example.servicecompany.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    public AccessControlFilter(RouteLocator routeLocator, MyWayProperties myWayProperties) {
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = myWayProperties.getGateway()
