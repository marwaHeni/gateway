...
public class FilesStorageServiceImpl  implements FilesStorageService{
    ...
    String pathName = "compaktorGatewayImages";
    ...
    public void init() throws IOException {
        ...
        File fileUsers = new File(realPath+"/"+pathName+"/"+"/users");
        File filePaymentSubscriptions = new File(realPath+"/"+pathName+"/"+"/paymentSubscriptions");
        File fileBanks = new File(realPath+"/"+pathName+"/"+"/banks");
        File filePdfs = new File(realPath+"/"+pathName+"/"+"/pdfs");

        if (!file.exists()) {
            file.mkdir();
            fileUsers.mkdir();
            filePaymentSubscriptions.mkdir();
            fileBanks.mkdir();
            filePdfs.mkdir();
        }else {
